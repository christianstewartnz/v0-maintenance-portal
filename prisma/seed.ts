    ...
    data: [
      {
        ...
        receivedAt: new Date("2026-02-28T09:15:00Z"),
        status: "needs_review",
      ...
      },
      {
        ...
        receivedAt: new Date("2026-02-27T14:30:00Z"),
        status: "needs_review",
        detectedUnitId: null,
      },
      {
        ...
        receivedAt: new Date("2026-02-26T11:00:00Z"),
        status: "processed",
      ...
      },
      {
        ...
        receivedAt: new Date("2026-02-25T16:45:00Z"),
        status: "needs_review",
      ...
      },
      {
        ...
        receivedAt: new Date("2026-02-27T10:00:00Z"),
        status: "needs_review",
  ...
  await prisma.item.createMany({
    data: [
      ...
      },
      {
        ...
        updatedAt: new Date("2026-02-28T09:30:00Z"),
      },
      {
        id: "item_03",
        projectId: "proj_01",
      ...
      },
      {
        ...
        priority: "Low",
        status: "New",
        createdAt: new Date("2026-02-26T12:15:00Z"),
        updatedAt: new Date("2026-02-27T10:15:00Z"),
      },
      {
        id: "item_05",
        projectId: "proj_01",
        ...
        priority: "Normal",
        status: "InProgress",
        createdAt: new Date("2026-02-25T17:00:00Z"),
      ...
      },
      {
        ...
        priority: "Normal",
        status: "New",
        createdAt: new Date("2026-02-28T09:45:00Z"),
        updatedAt: new Date("2026-02-28T09:45:00Z"),
      },
    ],
  });
